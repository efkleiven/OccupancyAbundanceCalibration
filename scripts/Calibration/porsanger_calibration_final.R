...
plot(pormean$int_4~pormean$Abundance_HT, pch=19, col=colorBlindBlack8[6], 
...
pdf("Plots/exp_porsanger.pdf", width=6,height=6)
{
  ...
  plot(expseq,expredv[,1], type="l", main="Porsanger",
...
pdf("Plots/log_porsanger.pdf", width=6,height=6)
{
  ...
  plot(seq,predv[,1], type="l", 
       xlab="log CT-counts (5-day interval)", ylab = "log mean CMR-abundance",
       main="Porsanger"
